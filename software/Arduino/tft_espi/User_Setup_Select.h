...
#include <User_Setups/Setup70h_ESP32_S3_GC9107_128x128.h>
...
#define PIN_MOSI 16  // SD1          FLASH and overlap mode
#define PIN_MISO -1  // SD0
#define PIN_SCLK 15  // CLK
#define PIN_HWCS 14  // D3
